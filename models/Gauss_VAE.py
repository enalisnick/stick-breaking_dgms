...
class Gaussian_VAE(object):
    def __init__(self, rng, input, batch_size, layer_sizes, 
        ...
        # init encoder
        self.encoder = GaussEncoder(rng, input=next_layer_input, batch_size=batch_size, in_size=layer_sizes[-1], latent_size=latent_size)
        ...
        self.post_mu = self.encoder.mu
        self.post_log_sigma = self.encoder.log_sigma
